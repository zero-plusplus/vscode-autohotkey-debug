...
export const createAELLUtils = (rawVersion: AutoHotkeyVersion | ParsedAutoHotkeyVersion): { createPseudoPrimitiveProperty: (value: string, type: dbgp.PrimitiveDataType) => PrimitivePropertyLike; createPrimitiveProperty: (value: string, type: dbgp.PrimitiveDataType, contextIdOrName?: dbgp.ContextId | dbgp.ContextName, stackLevel?: number) => PrimitivePropertyLike; createStringProperty: (value: string, contextIdOrName?: dbgp.ContextId | dbgp.ContextName | -1, stackLevel?: number) => PrimitivePropertyLike; createNumberProperty: (value: string | number | bigint, contextIdOrName?: dbgp.ContextId | dbgp.ContextName | -1, stackLevel?: number) => PrimitivePropertyLike; createBooleanProperty: (value: string | boolean, contextIdOrName?: dbgp.ContextId | dbgp.ContextName | -1, stackLevel?: number) => PrimitivePropertyLike; createUnsetProperty: (name: string, objectName?: string, contextIdOrName?: dbgp.ContextId | dbgp.ContextName | -1, stackLevel?: number) => PrimitivePropertyLike; createIdentifierProperty: <T extends PropertyLike>(...params: any[]) => T; toNumberType: (property: PropertyLike | undefined) => NumberType | undefined; toNumberByProperty: (property: PropertyLike | undefined) => number | undefined; toBooleanPropertyByProperty: (property: PropertyLike | undefined) => PrimitivePropertyLike; invertBoolean: (property: PropertyLike | undefined) => PrimitivePropertyLike; calc: (leftValue: PropertyLike, rightValue: PropertyLike, callback: CalcCallback) => PrimitivePropertyLike; equiv: (leftValue: PropertyLike, rightValue: PropertyLike, callback: EquivCallback) => PrimitivePropertyLike } => {
