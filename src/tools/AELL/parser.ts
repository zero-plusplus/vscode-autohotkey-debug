...
export const expressionNodeMapping = (() => {
  return {
    ...
    ReAssignmentExpression_addition:                    { kind: SyntaxKind.AssignExpression, left: 0, operator: 1, right: 2, startPosition, endPosition },
    ReAssignmentExpression_subtraction:                 { kind: SyntaxKind.AssignExpression, left: 0, operator: 1, right: 2, startPosition, endPosition },
    ReAssignmentExpression_multiplication:              { kind: SyntaxKind.AssignExpression, left: 0, operator: 1, right: 2, startPosition, endPosition },
    ReAssignmentExpression_division:                    { kind: SyntaxKind.AssignExpression, left: 0, operator: 1, right: 2, startPosition, endPosition },
    ReAssignmentExpression_floor_division:              { kind: SyntaxKind.AssignExpression, left: 0, operator: 1, right: 2, startPosition, endPosition },
    ReAssignmentExpression_concatenate:                 { kind: SyntaxKind.AssignExpression, left: 0, operator: 1, right: 2, startPosition, endPosition },
    ReAssignmentExpression_bitwise_or:                  { kind: SyntaxKind.AssignExpression, left: 0, operator: 1, right: 2, startPosition, endPosition },
    ReAssignmentExpression_bitwise_xor:                 { kind: SyntaxKind.AssignExpression, left: 0, operator: 1, right: 2, startPosition, endPosition },
    ReAssignmentExpression_bitwise_and:                 { kind: SyntaxKind.AssignExpression, left: 0, operator: 1, right: 2, startPosition, endPosition },
    ReAssignmentExpression_bitshift_left:               { kind: SyntaxKind.AssignExpression, left: 0, operator: 1, right: 2, startPosition, endPosition },
    ReAssignmentExpression_bitshift_right:              { kind: SyntaxKind.AssignExpression, left: 0, operator: 1, right: 2, startPosition, endPosition },
    ReAssignmentExpression_bitshift_logical_right:      { kind: SyntaxKind.AssignExpression, left: 0, operator: 1, right: 2, startPosition, endPosition },
