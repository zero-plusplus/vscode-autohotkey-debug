...
import { AhkDebugSession, DebugConfig, ExtraFeatures, PerfTipsConfig } from '../../adapter/ahkDebug';
...
import { AhkConfigurationProvider } from '../../adapter/ConfigurationProvider';
