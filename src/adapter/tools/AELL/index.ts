...
export const create = createEvaluator;
...
//   private readonly config: AELLConfig;
//   constructor(session: dbgp.Session, config?: Partial<AELLConfig>) {
...
//     const matchResult = parse(this.ahkVersion, expression);
