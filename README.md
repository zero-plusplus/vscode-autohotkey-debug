...
### Update
* `1.6.12` - 2021-xx-xx
    * Changed: [#110](https://github.com/zero-plusplus/vscode-autohotkey-debug/issues/110) Suppressing an error when obtaining a non-existent key in bracket notation
